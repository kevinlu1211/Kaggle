...
Xt_scale_projected <- res$x[,1:pc.use] ; Xt_scale_projected = (Xt_scale %*% res$rotation)[,1:pc.use]
...
#             100 * 3                                           3 * 50                                                  100 * 50
#
# We can think of it like each eigenvector holds some information as to how the projected data, onto 3 dimensions,
# is to be converted back to it's original dimensionality. Moreover, we can also see that the more eigenvectors used (and as a consequence 
# using more dimensions to represent the original data) the more accurately the projected data can be reconstructed
